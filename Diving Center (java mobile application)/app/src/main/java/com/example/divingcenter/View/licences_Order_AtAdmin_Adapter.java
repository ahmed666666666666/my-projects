...
public class licences_Order_AtAdmin_Adapter extends RecyclerView.Adapter<licences_Order_AtAdmin_Adapter.Holder> {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new licences_Order_AtAdmin_Adapter.Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.orders_layout, parent, false));
    }
