...
public class Equipments_orders_user_dapter extends RecyclerView.Adapter<Equipments_orders_user_dapter.Holder> {
    ...
    @NonNull
    @Override
    public Equipments_orders_user_dapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        auth = FirebaseAuth.getInstance();
        return new Equipments_orders_user_dapter.Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.orders_layout, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull Equipments_orders_user_dapter.Holder holder, int position) {
