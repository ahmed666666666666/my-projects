...
public class Equipment_Order_Adapter extends RecyclerView.Adapter<Equipment_Order_Adapter.Holder> {
    ...
    @NonNull
    @Override
    public Equipment_Order_Adapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        auth = FirebaseAuth.getInstance();
        return new Equipment_Order_Adapter.Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.orders_layout, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull Equipment_Order_Adapter.Holder holder, int position) {
