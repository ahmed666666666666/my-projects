...
class CoursesPaidAdapter extends RecyclerView.Adapter<CoursesPaidAdapter.Holder> {
    ...
    @NonNull
    @Override
    public CoursesPaidAdapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        auth = FirebaseAuth.getInstance();
        return new CoursesPaidAdapter.Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.orders_layout, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull CoursesPaidAdapter.Holder holder, int position) {
